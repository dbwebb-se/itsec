    ...
    <div class="w-75 w-100-mobile">
        ...
        <?php if (isset($_GET["page"])) : ?>
            <div class="d-flex justify-content-center">
                <a class="btn btn-lg btn-primary mb-4 mx-2" href="<?= $admin ?>/low?page=1">Start</a>
                <?php for ($i = $start; $i <= $end; $i++) : ?>
                    <a class="btn btn-lg btn-primary mb-4 mx-2" href="<?= $admin ?>/low?page=<?=$i?>"><?=$i?></a>
                <?php endfor; ?>
                <a class="btn btn-lg btn-primary mb-4 mx-2" href="<?= $admin ?>/low?page=<?=$totalPages?>">Slut</a>
            </div>
